...
def load_categories_and_tags() -> dict:
    ...
    registry of approved category/tag IDs. Returns just the two id sets,
    which is all validation and scoring ever need; no code anywhere else
    is allowed to invent or guess an id that isn't present here.
